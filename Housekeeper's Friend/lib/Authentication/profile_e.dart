...
class _ProfileState extends State<ProfileE> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
appBar: AppBar(
        title: new Text("List of Electrician", textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
        // leading: Padding(
...
Widget _buildBody(BuildContext context) {
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    final record = Recorde.fromSnapshot(data);
    ...
    context,
    MaterialPageRoute(
    	builder: (context) => ProfilePE(record,context)),
  );},
