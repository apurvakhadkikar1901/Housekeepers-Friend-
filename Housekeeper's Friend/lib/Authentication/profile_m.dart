...
class _ProfileState extends State<ProfileM> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
appBar: AppBar(
        title: new Text("List of Maids", textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Open Sans', fontWeight: FontWeight.bold)),
        // leading: Padding(
...
Widget _buildBody(BuildContext context) {
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    ...
    context,
    MaterialPageRoute(
    	builder: (context) => ProfilePM(record,context)),
  );},
