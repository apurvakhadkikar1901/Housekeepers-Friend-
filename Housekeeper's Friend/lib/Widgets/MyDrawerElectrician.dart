...
class MyDrawerVendorElectrician extends StatefulWidget{
  @override
  _MyDrawerState createState() => _MyDrawerState();
}

class _MyDrawerState extends State<MyDrawerVendorElectrician> {
  Recorde record;
...
ListTile(leading: Icon(Icons.shopping_bag,color:Colors.blue[600]),
              title:Text("View Others Profile",style:TextStyle(color:Colors.black87),),
               onTap: () {
                  Route route = MaterialPageRoute(builder: (c) => ProfileE());
                  Navigator.pushReplacement(context, route);
                },
 ),
 Divider(height: 10.0, color:Colors.white, //thickness:6.0,
...
//                onTap: () {
//                   Route route = MaterialPageRoute(builder: (c) => ProfilePE(record,context));
//                   Navigator.pushReplacement(context, route);
//                 },
//  ),
 Divider(height: 10.0, color:Colors.white, //thickness:6.0,
 ...
 ListTile(leading: Icon(Icons.home,color:Colors.blue[600]),
              title:Text("MyOrders",style:TextStyle(color:Colors.black),),
               onTap: () {
                  Route route = MaterialPageRoute(builder: (c) => OrderHomesE());
                  Navigator.pushReplacement(context, route);
                },
 ),
 Divider(height: 10.0, color:Colors.white, //thickness:6.0,
