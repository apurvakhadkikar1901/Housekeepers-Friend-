...
File _image;
class ProfilePM extends StatefulWidget {
Record1 record;
  BuildContext context;
  ProfilePM(this.record, this.context);
// Record1 record;
//   BuildContext context;
...
class _ProfileState extends State<ProfilePM> {
...
appBar: AppBar(
      ...
      body:StreamBuilder(stream: FirebaseFirestore.instance.collection('maid').snapshots(),
              ...
              height: 5.0,
                ...
                Container(
                 ...
                 RaisedButton(
                          ...
                          onPressed: () {
                           // createData();
                              Route route = MaterialPageRoute(builder: (context) => FeedFetch());
