...
import 'package:checklist/Vendors/technician/phone_sms_call_tech.dart';
...
SizedBox(height:30),
 ...
 RaisedButton(child: Text('Add Date'), onPressed: _pickDateDialog),
  ...
  createData(){
    ...
    CollectionReference ds=FirebaseFirestore.instance.collection('technicianUser');
...
//final String phoneNo;
  ...
  UserRecordT1.fromMap(Map<String, dynamic> map, {this.reference})
      :
        name = map['name'],
        email = map['email'],
       // hour = map['hours'],
...
//phoneNo = map['phoneNo'];
  ...
  UserRecordT1.fromSnapshot(DocumentSnapshot snapshot)
