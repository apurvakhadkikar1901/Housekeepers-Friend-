...
class OrderHomesT extends StatefulWidget {
  @override
  _StoreHomesState createState() => _StoreHomesState();
}

class _StoreHomesState extends State<OrderHomesT> {
  @override
 ...
 Widget _buildBody(BuildContext context) {
   User user = FirebaseAuth.instance.currentUser;
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("technicianUser").snapshots(),
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    final userrecord = UserRecordT1.fromSnapshot(data);
