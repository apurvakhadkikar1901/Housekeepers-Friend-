...
Recordt record;
  ...
  ProfilePT(this.record, this.context);
// Record1 record;
//   BuildContext context;
...
class _ProfileState extends State<ProfilePT> {
...
appBar: AppBar(
      ...
      body:StreamBuilder(stream: FirebaseFirestore.instance.collection('technician').snapshots(),
              ...
              height: 5.0,
                ...
                Container(
                 ...
                 RaisedButton(
                          ...
                          onPressed: () {
                           // createData();
                              Route route = MaterialPageRoute(builder: (context) => FeedFetcht());
