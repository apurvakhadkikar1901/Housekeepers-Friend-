...
class _FeedbackState extends State<Feedback1> {
  ...
  createData(){
    DocumentReference ds=FirebaseFirestore.instance.collection('feedback').doc();
              ...
              children: <Widget>[
                ...
                return null;
                  ...
                  ElevatedButton(child:Text('Submit'),onPressed: (){
                    ...
                    createData();
      Navigator.push(context, MaterialPageRoute(builder: (context)=>StoreHomes()));
                   } }, ),
     ElevatedButton(child:Text('View Feedback'),onPressed: (){
                   // createData();
      Navigator.push(context, MaterialPageRoute(builder: (context)=>FeedFetch()));
    }, ),
...
class FeedbackNew {
  ...
  @override
  String toString() => "Record1<$feedback>";
}  
