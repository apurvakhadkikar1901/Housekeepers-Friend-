...
class StoreHomesp extends StatefulWidget {
  @override
  _StoreHomesState createState() => _StoreHomesState();
}

class _StoreHomesState extends State<StoreHomesp> {
  @override
...
//width: MediaQuery.of(context).size.width,
  //            height: MediaQuery.of(context).size.height - 100,
    ...
    ElevatedButton(child:Text('Send SMS'),onPressed: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>PhoneFetchP(precord,context)));
    }, ),
