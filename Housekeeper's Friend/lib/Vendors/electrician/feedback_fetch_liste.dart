...
class FeedFetche extends StatefulWidget {
  @override
  _StoreHomesState createState() => _StoreHomesState();
}

class _StoreHomesState extends State<FeedFetche> {
  @override
 ...
 Widget _buildBody(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("feedbacke").snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) return LinearProgressIndicator();
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    final record = FeedbackNewe.fromSnapshot(data);
