...
import 'package:checklist/Vendors/electrician/feedback_fetch_liste.dart';
...
File _image;
class ProfilePE extends StatefulWidget {
Recorde record;
  BuildContext context;
  ProfilePE(this.record, this.context);
// Record1 record;
//   BuildContext context;
...
class _ProfileState extends State<ProfilePE> {
  ...
  User user = FirebaseAuth.instance.currentUser;
    ...
    DocumentReference ds=FirebaseFirestore.instance.collection('electrician').doc();
...
appBar: AppBar(
      ...
      body:StreamBuilder(stream: FirebaseFirestore.instance.collection('electrician').snapshots(),
              ...
              height: 5.0,
                ...
                Container(
                 ...
                 RaisedButton(
                          ...
                          onPressed: () {
                           // createData();
                              Route route = MaterialPageRoute(builder: (context) => FeedFetche());
