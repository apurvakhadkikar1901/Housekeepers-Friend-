...
import 'PhoneFeche.dart';

import 'electricianfome.dart';
import 'feedback_forme.dart';
...
class electricianh extends StatefulWidget {
  @override
  _electricianhState createState() => _electricianhState();
}

class _electricianhState extends State<electricianh> {
  @override
 ...
 Widget _buildBody(BuildContext context) {
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
   ...
   //width: double.maxFinite,
    ...
    context,
    MaterialPageRoute(
    	builder: (context) => addtocarde(recorde,context)),
  );
            },
   child: Card(
  ...
  //            height: MediaQuery.of(context).size.height - 100,
    ...
    // )
                           ...
                           Row(children: [
                            ...
                            ElevatedButton(child:Text('Feedback'),onPressed: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>Feedback1e()));
    }, ),
    SizedBox(
