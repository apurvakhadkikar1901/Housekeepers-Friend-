...
User user = FirebaseAuth.instance.currentUser;
    DocumentReference ds=FirebaseFirestore.instance.collection('electricianUser').doc();
...
backgroundColor: Colors.blue[600],
      ...
      body:StreamBuilder(stream: FirebaseFirestore.instance.collection('electricianUser').snapshots(),
