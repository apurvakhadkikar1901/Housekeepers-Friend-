...
class OrderHomesM extends StatefulWidget {
  @override
  _StoreHomesState createState() => _StoreHomesState();
}

class _StoreHomesState extends State<OrderHomesM> {
  @override
 ...
 Widget _buildBody(BuildContext context) {
   User user = FirebaseAuth.instance.currentUser;
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection("maidUser").snapshots(),
  ...
  Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
    final userrecord = UserRecordM1.fromSnapshot(data);
  ...
  //   context,
  //   MaterialPageRoute(
  //   	builder: (context) => addtocardp(precord,context)),
  // );
  //           },
   child: Card(
