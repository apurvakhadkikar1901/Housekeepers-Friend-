...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> verifyOtp() async {
    ...
    //         DocumentReference ds=FirebaseFirestore.instance.collection("vendor").doc(currentUser.uid);
    ...
    // ds.set(vendorPhone).whenComplete((){
    //   print("information updated");});
         
    //  DocumentReference ds=FirebaseFirestore.instance.collection("vendor").doc(user.uid);
    //     Map<String,dynamic> vendorPhone = {
    //   "phoneNo":phoneNo,
...
createData(String phoneNO){
  
    User user = FirebaseAuth.instance.currentUser;
    DocumentReference ds=FirebaseFirestore.instance.collection('vendor').doc();
